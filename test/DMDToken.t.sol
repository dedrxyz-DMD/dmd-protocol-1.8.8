...
contract DMDTokenTest is Test {
    ...
    function setUp() public {
        ...
        token = new DMDToken(mintDistributor);
    }
    ...
    function test_Constructor() public {
        ...
        assertEq(token.mintDistributor(), mintDistributor);
    ...
    function test_SupplyTracking_MintAndBurn() public {
        ...
        assertEq(token.circulatingSupply(), 1000e18);
        ...
        assertEq(token.circulatingSupply(), 700e18);
    }
